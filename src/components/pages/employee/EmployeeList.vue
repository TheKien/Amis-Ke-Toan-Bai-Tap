              ...
              <tr v-for="employee in employeeList" :key="employee.EmployeeId">
                ...
                <td>
                  <div class="m-flex-item-center">
                    ...
                    <div class=" m-dropdown" :class="{ 'm-dropdown-active': showBtnDel && employeeId===employee.EmployeeId}"
                        @click="onClickShowBtnDel(employee.EmployeeId)">
                      <div
                        class="mi mi-14 mi-arrow-up--blue"
      ...
      <div class="main-footer">
        ...
        <div class="page-size">
          <select name="" id="" v-model="pageSize">
            ...
            <option value="15">11 bản ghi/ trang</option>
          </select>
        </div>
